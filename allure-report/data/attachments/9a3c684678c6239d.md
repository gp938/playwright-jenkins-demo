...
Call log:
  - navigating to "https://playwright.dev/", waiting until "domcontentloaded"
    ...
    - main [ref=e46]:
      ...
      - generic [ref=e121]:
        ...
        - paragraph [ref=e122]:
          ...
          - link "Python" [ref=e123] [cursor=pointer]:
            - /url: https://playwright.dev/python/docs/intro
          - text: ","
          - link ".NET" [ref=e124] [cursor=pointer]:
            - /url: https://playwright.dev/dotnet/docs/intro
          - text: ", and"
          - link "Java" [ref=e125] [cursor=pointer]:
            - /url: https://playwright.dev/java/docs/intro
          - text: .
      - generic [ref=e129]:
        - heading "Chosen by companies and open source projects" [level=2] [ref=e130]
        - list [ref=e131]:
          - listitem:
            - link "VS Code":
    ...
    - generic [ref=e133]:
      - generic [ref=e134]:
        - generic [ref=e135]:
          ...
          - list [ref=e137]:
            - listitem [ref=e138]:
              - link "Getting started" [ref=e139] [cursor=pointer]:
                - /url: /docs/intro
            - listitem [ref=e140]:
              - link [ref=e141] [cursor=pointer]:
                - /url: https://learn.microsoft.com/en-us/training/modules/build-with-playwright/
                - text: Playwright Training
                - img "(opens in new tab)" [ref=e142]
            - listitem [ref=e144]:
              - link "Learn Videos" [ref=e145] [cursor=pointer]:
                - /url: /community/learn-videos
            - listitem [ref=e146]:
              - link "Feature Videos" [ref=e147] [cursor=pointer]:
        ...
        - generic [ref=e167]:
          ...
          - list [ref=e169]:
            ...
            - listitem [ref=e182]:
              - link "Ambassadors" [ref=e183] [cursor=pointer]:
      ...
      - generic [ref=e188]: Copyright © 2026 Microsoft
```
